    ...
    const handleSubmit = async () => {
        try {
            ...
            if (result.data.success) {
                const encryptedPass = crypto.AES.encrypt(formData.password, "my-proj").toString()
                        ...
                        <div>
                            ...
                            <div className="mt-2 relative">
                                ...
                                <div className='mt-2'>
                                    ...
                                    />
                                    <label htmlFor="check" className='text-sm ml-1 text-gray-500 select-none'>Show Password</label>
                                </div>
                            </div>
                        </div>
